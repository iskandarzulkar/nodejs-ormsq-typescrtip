...
router.get("/role/:id",  Authorization.Authenticated, Authorization.BasicUsers, RoleController.GetRoleById);
...
router.post("/role-menu-access", MenuValidation.CreateRoleMenuAccess, Authorization.Authenticated, Authorization.SuperUsers, RoleMenuAccessController.CreateAccess)
...
router.patch("/role-menu-access/:id",  MenuValidation.CreateRoleMenuAccess, Authorization.Authenticated, Authorization.SuperUsers, RoleMenuAccessController.UpdateAccess)
